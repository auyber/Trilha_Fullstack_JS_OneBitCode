interface GithubUserResponse {
  ...
  //Na interface GithubRepoResponse temos a propriedade owner. podemos utilizar o omit substituindo o owner por:
  ...
  //Se declararmos agora uma variável com o tipo GithubRepoResponse vemos através do autocompletar que ela não possui em owner os tipos que removemos:
...
//Diferente do Omit, o Pick trabalha apenas dentro das possíveis propriedades do tipo a ser copiado, logo o autocompletar funciona até mesmo na hora de declarar a união de strings.
